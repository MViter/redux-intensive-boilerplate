...
export default class Feed extends Component {
    ...
    /*constructor () {
        super();
        //this.getNewMoovies = ::this._getNewMoovies;
    }*/
    ...
    // async _getNewMoovies () {
    //
    //     await fetch(`https://api.themoviedb.org/3/movie/now_playing?api_key=91c1a5a46a2617a97b91f80720f8f7bf&page=1`, {
    //         method: 'GET'
    //     })
    //         .then((response) => {
    //
    //             if (response.status !== 200) {
    //                 throw new Error('Moovies were not loaded.');
    //             }
    ...
    render () {
        ...
        return (
            <section>
                <Grid results = { results } genres = { genres } />}
            </section>
        );
    }
}
